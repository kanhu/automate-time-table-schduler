...
/**
 * A chromosome here is a collection or an array of Genes. It is the main class
 * of algorithm and it undergoes crossover and mutation to furnish fitter
 * individuals.
 * 
 * @author krudash
 *
...
public class Chromosome implements Comparable<Chromosome>, Serializable {
	...
	public void printTimeTable() {
		...
		for (int i = 0; i < nostgrp; i++) {
			...
			// status used to get name of student grp because in case first class is free it
			// will throw error
